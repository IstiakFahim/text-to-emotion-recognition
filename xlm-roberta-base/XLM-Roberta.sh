#!/bin/bash
#SBATCH --job-name=XLM-Roberta
#SBATCH --output=XLM-Roberta_output_%j.txt
#SBATCH --error=XLM-Roberta_error_%j.txt
...
yes | python3 /scratch/project_2011211/Fahim/a_nlp/XLM-Roberta.py

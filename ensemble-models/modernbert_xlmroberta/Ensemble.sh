#!/bin/bash
#SBATCH --job-name=EnsembleBERT
#SBATCH --output=EnsembleBERT_output_%j.txt
#SBATCH --error=EnsembleBERT_error_%j.txt
...
yes | python3 /scratch/project_2011211/Fahim/a_nlp/Ensemble.py

...
MODEL_DIR_1 = "bert_finetuned"     # path to your first fine-tuned model
MODEL_DIR_2 = "distilbert_finetuned"     # path to your second fine-tuned model
TEXT_COL = "text"
LABEL_COL = "label"
MAX_LENGTH = 512
BATCH_SIZE = 16
OUTPUT_REPORT_DIR = "ensemble_reports_bert_distilbert"
SEED = 42
